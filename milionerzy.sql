...
--
-- Host: 127.0.0.1
-- Czas generowania: 23 Lip 2020, 13:13
...
INSERT INTO `users` (`ID`, `Nick`, `Surname`, `email`, `password`, `bestScore`, `games`, `HowManyWins`, `Type`, `HMUQ`) VALUES
(1, 'admin', 'Robert', 'test@test.pl', '123', 0, 0, 0, 1, 0),
(4, 'Test', 'Test', 'Testy12345@gmail.com', 'Qw11', 1000000, 4, 4, 0, 0),
(5, 'Test12', 'Test12', 'rob1@gmail.com', 'Qw11', 1000, 4, 0, 0, 0),
(6, 'Test22', 'Test22', 'tsta1@gmail.com', 'Qw11', 0, 0, 0, 0, 0),
(7, 'Test3211312', 'Robert', 'Robert@gmail.pl', 'Qw11', 0, 0, 0, 0, 0),
(8, 'Test121', 'Robert', 'Robert1@wp.pl', 'Qw11', 0, 0, 0, 0, 0);
